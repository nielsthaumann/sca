...
<br></br>
'Neuronal spiking' with systematic noise and influx of Ca2+ ions are a part of the electrochemical signaling cascade, where one neuron triggers a post-synaptic 'local field potential' in another neuron. The post-synaptic 'local field potential' from a large number (>10,000) of neurons are the main contributors to the brain activity measured with MEG/EEG: 
<br></br>
<p align="left">
