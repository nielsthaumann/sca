...
The [runsca_hsac.m](https://github.com/nielsthaumann/sca/blob/master/runsca_hsac.m) is recommended when the aim is to filter out interfering neural components before performing within-participant and between-participant comparisons. [runsca_hsac.m](https://github.com/nielsthaumann/sca/blob/master/runsca_hsac.m) enables relatively a liberal suppression of interfering neural acitivity, with a relatively low risk of mistakenly filtering out true evoked responses of interest. </br></br>
The more conservative statistical thresholding is recommended with the <a href="https://github.com/nielsthaumann/sca/blob/master/runsca_stats.m">runsca_stats.m</a> function, when the aim is to test whether an evoked response is present (or not), since it applies a relatively conservative statistical test to identify true evoked responses. </br>
