...
<br></br>
'Neuronal spiking' with systematic noise and influx of Ca2+ ions are a part of the electrochemical signaling cascade that triggers post-synaptic 'local field potentials'. The post-synaptic 'local field potentials' from a large number (>10,000) of neurons are the main contributors to the evoked responses measured with MEG/EEG: 
<br></br>
<p align="left">
