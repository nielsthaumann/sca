...
A popular assumption is that brain activity measured with MEG/EEG is shaped as ideal sine waves. However, in line with the observations of systematic noise in the timing of 'neuronal spiking', it turns out that the brain activity measured with MEG/EEG is more accurately modeled with systematic Gaussian noise in the timing of the activity than with ideal sine waves ([Haumann et al., 2020](https://doi.org/10.1016/j.jneumeth.2020.108743)). 
<br>
</br>
